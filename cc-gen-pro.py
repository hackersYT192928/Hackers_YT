...
def usage():
    ...
    print("+---------------+")
    print("")
    print("\033[1;36m     python2 cc-gen-pro.py -b     [Opciones de uso]")
    ...
    print("")
    print("\033[1;36m     python2 cc-gen-pro.py -b 123456xxxxxxxxxx -u 40 -d -c ")
    print("")
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por HackersYT\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: Brayan_Lopez\033[0m")
    print("\033[1;33m Youtube: Hackers yt\033[0m")
    print("\033[1;33m Facebook: Brayan Alexis Marin Lopez")
    print("")
